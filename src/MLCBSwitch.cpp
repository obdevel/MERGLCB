...
void MLCBSwitch::setPin(byte pin, byte pressedState = LOW) {
...
byte MLCBSwitch::readPin(byte pin) {

  return digitalRead(pin);
}

void MLCBSwitch::run(void) {
...
bool MLCBSwitch::stateChanged(void) {
...
bool MLCBSwitch::isPressed(void) {
...
unsigned long MLCBSwitch::getCurrentStateDuration(void) {
...
unsigned long MLCBSwitch::getLastStateDuration(void) {
...
unsigned long MLCBSwitch::getLastStateChangeTime(void) {
...
void MLCBSwitch::resetCurrentDuration(void) {

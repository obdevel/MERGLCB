...
bool MLCBConfig::setEEPROMtype(byte type) {
...
void MLCBConfig::setExtEEPROMAddress(byte address, TwoWire *bus) {
...
void MLCBConfig::setFLiM(bool f) {
...
void MLCBConfig::setCANID(byte canid) {
...
void MLCBConfig::setNodeNum(unsigned int nn) {
...
byte MLCBConfig::findExistingEvent(unsigned int nn, unsigned int en) {
...
byte MLCBConfig::findEventSpace(void) {
...
byte MLCBConfig::makeHash(byte tarr[4]) {
...
void MLCBConfig::readEvent(byte idx, byte tarr[]) {
...
byte MLCBConfig::getEventEVval(byte idx, byte evnum) {
...
void MLCBConfig::writeEventEV(byte idx, byte evnum, byte evval) {
...
void MLCBConfig::makeEvHashTable(void) {
...
void MLCBConfig::updateEvHashEntry(byte idx) {
...
void MLCBConfig::clearEvHashTable(void) {
...
void MLCBConfig::printEvHashTable(bool raw) {
...
byte MLCBConfig::numEvents(void) {
...
byte MLCBConfig::getEvTableEntry(byte tindex) {
...
byte MLCBConfig::readNV(byte idx) {
...
void MLCBConfig::writeNV(byte idx, byte val) {
...
byte MLCBConfig::readEEPROM(unsigned int eeaddress) {
...
byte MLCBConfig::readBytesEEPROM(unsigned int eeaddress, byte nbytes, byte dest[]) {
...
void MLCBConfig::writeEEPROM(unsigned int eeaddress, byte data) {
...
void MLCBConfig::writeBytesEEPROM(unsigned int eeaddress, byte src[], byte numbytes) {
...
void MLCBConfig::writeEvent(byte index, byte data[]) {
...
void MLCBConfig::cleareventEEPROM(byte index) {
...
void MLCBConfig::resetEEPROM(void) {
...
unsigned int MLCBConfig::freeSRAM(void) {
#ifdef __AVR__
...
bool MLCBConfig::check_hash_collisions(void) {
...
void MLCBConfig::setChipEEPROMVal(unsigned int eeaddress, byte val) {
...
byte MLCBConfig::getChipEEPROMVal(unsigned int eeaddress) {
...
void MLCBConfig::setResetFlag(void) {

  writeEEPROM(5, 99);
}

void MLCBConfig::clearResetFlag(void) {

  writeEEPROM(5, 0);
}

bool MLCBConfig::isResetFlagSet(void) {
